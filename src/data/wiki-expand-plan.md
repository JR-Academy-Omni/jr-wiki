...
- [x] n8n-guide/04-advanced-tips.md — new-chapter: 高阶技巧（sub-workflow / error workflow / credentials 管理）
- [x] n8n-guide/05-faq.md — new-chapter: FAQ 与故障排查（常见报错 / 性能瓶颈 / 与 Make 对比）
